    ...
    <footer className="border-t border-indigo-100 dark:border-gray-800 py-10 md:py-12 bg-white dark:bg-gray-950">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4">{t('footer.resources.title')}</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4">{t('footer.company.title')}</h3>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/contact"
